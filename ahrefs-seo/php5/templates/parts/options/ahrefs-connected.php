...
$disconnect_link = add_query_arg( [ 'disconnect-ahrefs' => wp_create_nonce( $locals['page_nonce'] ) ], 'settings' === $locals['disconnect_link'] ? Links::settings( Ahrefs_Seo_Screen_Settings::TAB_ACCOUNT ) : Links::wizard_step( 1 ) );
